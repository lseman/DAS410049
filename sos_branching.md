...
3. [Pseudo-Shadow Prices](#pseudo-shadow-price)
...
4. [Degradation for SOS1](#sos1-specific-formulation)
...
5. [Degradation for SOS2](#sos2-degradation)
...
6. [How Degradation Guides Branching](#how-is-degradation-used-for-branching)
...
$$D_{Ak} = \sum_i \max \left\{ p_i^+ \cdot (a_{Cik} - a_{Aik}),\ - p_i^- \cdot (a_{Cik} - a_{Aik}),\ \pi_i \cdot (a_{Cik} - a_{Aik}) \right\} \tag{12}$$
...
$$D_{Ak}^- = \sum_i \max \left\{ p_i^+ (a_{Cik}^- - a_{Aik}), - p_i^- (a_{Cik}^- - a_{Aik}), \pi_i (a_{Cik}^- - a_{Aik}) \right\}$$
...
$$a_{Ak} = - \sum_j x_j \cdot a(t_j) = - (0.1 \cdot 2 + 0.3 \cdot 3 + 0.6 \cdot 4) = - (0.2 + 0.9 + 2.4) = -3.5 \tag{7}$$
...
$$a_{Ak} = -\sum_j \lambda_j \cdot a(t_j) = - (0.3 \cdot 0 + 0 \cdot 1 + 0.7 \cdot 4 + 0 \cdot 9) = -2.8 \tag{5}$$
...
$$D_{Ak} = \max\left\{ 0.0001 \cdot 5.0,\ -0.0001 \cdot 5.0,\ 1.5 \cdot 5.0 \right\} = \max\{0.0005,\ -0.0005,\ 7.5\} = 7.5 \tag{10}$$
...
$$D_{Ik}(t) = \sum_i \max\left\{ p_i^+ (a_i(t) - \tilde{a}_i(t)), - p_i^- (a_i(t) - \tilde{a}_i(t)), \pi_i (a_i(t) - \tilde{a}_i(t)) \right\} \tag{15}$$
